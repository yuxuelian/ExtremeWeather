...
import com.as.weather.adapter.OnItemClickListener;
import com.as.weather.adapter.RecyclerViewDivider;
import com.as.weather.adapter.SlidingListAdapter;
import com.as.weather.adapter.helper.OnStartDragListener;
import com.as.weather.adapter.helper.SimpleItemTouchHelperCallback;
import com.as.weather.model.bean.SlidingWeatherBean;
import com.as.weather.ui.activity.AboutActivity;
import com.as.weather.ui.activity.MainActivity;
import com.as.weather.ui.activity.SettingActivity;
...
public class SlidingMenuFragment extends Fragment
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //设置状态栏的高度
        viewHolder.slidingMainView.setPadding(0, DeviceBarUtil.getStatusBarHeight(mAttachActivity), 0, 0);
...
//        Toast.makeText(mAttachActivity, "dismiss" + position, Toast.LENGTH_SHORT).show();
    ...
    @OnClick({R.id.sliding_add_button, R.id.sliding_setting_button, R.id.sliding_about_button})

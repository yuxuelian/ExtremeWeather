...
public class BitmapBlurUtil {
    ...
    public static Bitmap blur(
            @FloatRange(from = 0.0f, fromInclusive = false) float scaleFactor,
            @FloatRange(from = 0.0f, to = 25f, fromInclusive = false) float radius, Context mContext, Bitmap mInputBitmap, View mTargetView) {
